...
urlpatterns = [
    ...
    # 新增 3 # 大屏图谱的异步搜索接口
    path('analysis/search/', views.analysis_graph_search, name='analysis_search'),
    # DeepSeek 问答接口
    path('deepseek/ask/', views.deepseek_ask, name='deepseek_ask'),
    # 搜索建议
    path('autocomplete/', views.autocomplete_api, name='autocomplete'),
    # 机器学习智能诊断实验室
    path('smart_diagnosis/', views.smart_diagnosis, name='smart_diagnosis'),
]
